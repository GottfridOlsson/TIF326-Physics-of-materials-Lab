...
def Delta_sigma_Canvas(alpha, M, G, b, N, r):
    return alpha*M*G*b*np.sqrt(N*2*r)
...
x = 0.9             #-, volume fraction Al (estimated from alloy composition)
...
Delta_sigma_new = Delta_sigma_Canvas(alpha, M, G, b, N, r)*1e-6              #MPa
